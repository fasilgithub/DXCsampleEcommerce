<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="DXCsampleEcommerce.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:DataList ID="DataList1" runat="server">
        ...
        <tr>
            <br />
            <%--<td style="padding-right:100px"><asp:Image Height="400" Width=""  ID="Image1" runat="server" ImageUrl=<%#Eval("Imagepath") %>></asp:Image></td>--%>
